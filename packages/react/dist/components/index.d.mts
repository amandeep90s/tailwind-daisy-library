...
type AmountFieldVariant = "bordered" | "ghost";
...
interface DatePickerProps extends Omit<React__default.InputHTMLAttributes<HTMLInputElement>, "type" | "onChange" | "value" | "min" | "max" | "min" | "max"> {
    /** Selected date */
    value?: Date;
