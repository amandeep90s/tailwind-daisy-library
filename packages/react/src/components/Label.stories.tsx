...
export const WithRequiredInput: Story = {
	render: () => (
		<div className="form-control w-64">
			...
			<input id="email" type="email" placeholder="name@example.com" className="input input-bordered w-full" required />
		</div>
	),
};
	...
	render: () => (
		<form className="flex flex-col gap-4 w-80">
			<div className="form-control">
				...
				<input id="name" type="text" placeholder="John Doe" className="input input-bordered w-full" required />
			</div>
			...
			<div className="form-control">
				...
				<input id="website" type="url" placeholder="https://example.com" className="input input-bordered w-full" />
