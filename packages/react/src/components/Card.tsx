...
export const Card = forwardRef<HTMLDivElement, CardProps>(
	({ variant = "default", imageSrc, imageAlt = "", children, className, ...props }, ref) => {
		return (
			<div ref={ref} className={clsx("card", variantClasses[variant], className)} {...props}>
				{imageSrc && (
					<figure>
...
export const CardBody = forwardRef<HTMLDivElement, CardBodyProps>(({ children, className, ...props }, ref) => {
	return (
