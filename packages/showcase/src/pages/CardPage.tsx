  ...
  return (
    <ComponentPage title="Card" description="Displays a card with header, content, and footer.">
      ...
      <ShowcaseSection
        ...
        description="Add action buttons to the card footer."
      >
        <Card className="w-96">
          <CardBody>
      ...
      <ShowcaseSection
        ...
        description="Cards can include images for richer visual content."
      >
        <Card className="w-96">
          <figure>
            <img
      ...
      <ShowcaseSection
        title="Side Layout"
        description="Card with image on the side instead of top."
      >
        <Card variant="side" className="w-full max-w-lg">
