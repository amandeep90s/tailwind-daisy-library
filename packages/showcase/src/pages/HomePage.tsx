...
export function HomePage() {
	return (
		<div className="max-w-4xl">
			<h1 className="text-4xl font-bold mb-4">Shared UI Library</h1>
			<p className="text-lg text-base-content/70 mb-8">
				A framework-agnostic UI component library built with TailwindCSS v4 and DaisyUI v5. This showcase demonstrates
				all available components and their variants.
			</p>
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
					...
					<div className="card bg-base-200 shadow-md">
						<div className="card-body">
							...
							<p className="text-sm text-base-content/60 mb-4">Buttons with multiple variants, sizes, and states.</p>
					...
					<div className="card bg-base-200 shadow-md">
						<div className="card-body">
							...
							<p className="text-sm text-base-content/60 mb-4">Text inputs with labels, validation, and helper text.</p>
					...
					<div className="card bg-base-200 shadow-md">
						<div className="card-body">
							...
							<p className="text-sm text-base-content/60 mb-4">Form labels with required indicator support.</p>
							<div>
			...
			<section className="mb-12">
				<h2 className="text-2xl font-semibold mb-4">Framework Agnostic Usage</h2>
				<p className="text-base-content/70 mb-4">For non-React projects, use the DaisyUI class variants directly:</p>
				<div className="mockup-code bg-base-300 text-base-content">
					<pre data-prefix="1">
