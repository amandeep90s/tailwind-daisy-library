...
export function AlertPage() {
  return (
    <ComponentPage
      title="Alert"
      description="Displays a callout for user attention with different variants and automatic icons."
    >
      <ShowcaseSection
        title="Basic Variants"
        description="All alerts come with default icons for their variant."
      >
      ...
      <ShowcaseSection
        ...
        description="Use AlertTitle and AlertDescription for structured content."
      >
        <div className="w-full space-y-4">
          <Alert variant="info">
            <div>
          ...
          <Alert variant="error">
            <div>
              ...
              <AlertDescription>
                The file size exceeds the maximum allowed limit of 10MB.
              </AlertDescription>
            </div>
          </Alert>
        </div>
