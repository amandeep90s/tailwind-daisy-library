	...
	return (
		<div className="max-w-4xl">
			...
			<p className="text-lg text-base-content/70 mb-8">
				Labels are used to identify form elements. They support required indicators and alternative styles.
			</p>
			...
			{/* With Form Elements */}
			<section className="mb-12">
				<h2 className="text-2xl font-semibold mb-4">With Form Elements</h2>
				<div className="max-w-sm space-y-6">
					...
					<div className="form-control">
						...
						<input id="email" type="email" placeholder="name@example.com" className="input input-bordered w-full" />
					</div>
			...
			<section className="mb-12">
				<h2 className="text-2xl font-semibold mb-4">Using with Input Component</h2>
			...
			<section className="mb-12">
				...
				<form className="max-w-sm space-y-4 p-6 bg-base-200 rounded-lg">
					<div className="form-control">
					...
					<div className="form-control">
						...
						<input id="form-phone" type="tel" placeholder="+1 (555) 000-0000" className="input input-bordered w-full" />
