...
export function DrawerPage() {
	...
	return (
		<ComponentPage title="Drawer" description="A panel that slides out from the edge of the screen.">
			<ShowcaseSection title="Left Drawer">
				...
				<Drawer
					...
					position="left"
					content={
						<div className="p-4 w-80 bg-base-100 h-full">
							<h3 className="font-bold text-lg mb-4">Left Drawer</h3>
			...
			<ShowcaseSection title="Right Drawer">
				...
				<Drawer
					...
					content={
						<div className="p-4 w-80 bg-base-100 h-full">
							<h3 className="font-bold text-lg mb-4">Right Drawer</h3>
