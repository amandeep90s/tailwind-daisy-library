    ...
    >
      ...
      <ShowcaseSection title="Table Sizes" description="Tables come in different sizes.">
        <div className="w-full space-y-4 overflow-x-auto">
          <div>
            <p className="mb-2 text-sm font-medium">Extra Small (xs)</p>
            <Table size="xs">
              <thead>
                <tr>
                  <th>Name</th>
      ...
      <ShowcaseSection title="Pinned Rows" description="Pin header rows when scrolling.">
        ...
        <p className="text-base-content/70 mt-2 text-sm">Scroll to see pinned header</p>
      </ShowcaseSection>
      ...
      <ShowcaseSection
        title="With Caption and Footer"
        description="Table with caption and footer totals."
      >
        <div className="w-full overflow-x-auto">
          <Table>
            <caption className="text-base-content/70 mb-2 caption-top text-sm">
            ...
            <tfoot>
              <tr>
                ...
                <td className="text-success font-bold">+19%</td>
              </tr>
            </tfoot>
          </Table>
        </div>
      ...
      <ShowcaseSection
        ...
        description="Simplified data table with column definitions."
      >
        <div className="w-full overflow-x-auto">
          <DataTable
            data={users}
...
/>`}
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="mb-2 text-xl font-semibold">Table Props</h3>
            <PropsTable
              props={[
                {
                  name: "size",
          ...
          <div>
            <h3 className="mb-2 text-xl font-semibold">DataTable Props</h3>
            <PropsTable
              props={[
                {
                  name: "data",
