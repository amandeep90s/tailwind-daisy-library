	...
	return (
		<ComponentPage title="Avatar" description="Displays an image avatar with fallback support.">
			...
			<ShowcaseSection title="With Ring">
				...
				<Avatar size="lg" src="https://i.pravatar.cc/150?img=17" alt="Primary Ring" ring ringColor="primary" />
				<Avatar size="lg" src="https://i.pravatar.cc/150?img=18" alt="Secondary Ring" ring ringColor="secondary" />
				<Avatar size="lg" src="https://i.pravatar.cc/150?img=19" alt="Accent Ring" ring ringColor="accent" />
			</ShowcaseSection>

			{/* Ring with Offset */}
			<ShowcaseSection title="Ring with Offset">
				<Avatar size="lg" src="https://i.pravatar.cc/150?img=20" alt="Ring Offset" ring ringOffset />
				<Avatar
					size="lg"
			...
			<ShowcaseSection title="Avatar Group with Ring">
				<AvatarGroup>
					<Avatar size="md" src="https://i.pravatar.cc/150?img=35" alt="User 1" ring ringColor="primary" />
					<Avatar size="md" src="https://i.pravatar.cc/150?img=36" alt="User 2" ring ringColor="primary" />
					<Avatar size="md" src="https://i.pravatar.cc/150?img=37" alt="User 3" ring ringColor="primary" />
				</AvatarGroup>
			</ShowcaseSection>
			...
			<ShowcaseSection title="Combined Features">
				...
				<Avatar size="lg" fallback="CD" shape="hexagon" ring ringColor="accent" placeholderColor="secondary" />
			</ShowcaseSection>
		</ComponentPage>
	);
}
