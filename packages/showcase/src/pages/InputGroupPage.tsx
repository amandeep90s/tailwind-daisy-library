  ...
  return (
    <ComponentPage title="Input Group" description="Combine input fields with addons and buttons.">
      <ShowcaseSection
        ...
        description="Add text prefixes or suffixes to inputs."
      >
        <div className="w-full max-w-md">
          <InputGroup>
            <span className="bg-base-300 flex items-center px-3">https://</span>
      ...
      <ShowcaseSection title="With Icon Addon" description="Use icons as visual cues.">
        <div className="w-full max-w-md space-y-4">
          <InputGroup>
            <span className="bg-base-300 flex items-center px-3">
      ...
      <ShowcaseSection
        title="Addons on Both Sides"
        description="Add prefixes and suffixes together."
      >
        <div className="w-full max-w-md space-y-4">
          <InputGroup>
            <span className="bg-base-300 flex items-center px-3">
            ...
            <span className="bg-base-300 flex items-center px-3">USD</span>
          </InputGroup>
          ...
          <InputGroup>
            ...
            <span className="bg-base-300 flex items-center px-3">.com</span>
          </InputGroup>
        </div>
      </ShowcaseSection>
      ...
      <ShowcaseSection title="Different Sizes" description="Input groups adapt to input sizes.">
        <div className="w-full max-w-md space-y-4">
          <div>
            ...
            <InputGroup>
              <span className="bg-base-300 flex items-center px-3 text-sm">@</span>
          ...
          <div>
            ...
            <InputGroup>
              <span className="bg-base-300 flex items-center px-3 text-lg">@</span>
      ...
      <ShowcaseSection
        title="Vertical Input Group"
        description="Stack inputs vertically for forms."
      >
...
<InputGroup>
  ...
  <Button variant="primary">Search</Button>
      ...
      <section className="space-y-4">
        ...
        />
        <div className="mt-4">
          <h3 className="mb-2 text-xl font-semibold">Usage Notes</h3>
          <ul className="text-base-content/70 list-inside list-disc space-y-1">
            <li>
              Use <code className="bg-base-200 rounded px-1 text-sm">span</code> elements with{" "}
              <code className="bg-base-200 rounded px-1 text-sm">bg-base-300</code> for text/icon
              addons
            </li>
