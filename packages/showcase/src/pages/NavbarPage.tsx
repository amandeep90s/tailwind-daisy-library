  ...
  return (
    ...
    >
      ...
      <ShowcaseSection
        ...
        description="Navbar with a hamburger menu icon and title."
      >
        <Navbar className="rounded-box">
          <NavbarStart>
      ...
      <ShowcaseSection
        title="Navbar with Dropdown Menu"
        description="Navbar with dropdown submenu."
      >
        <Navbar className="rounded-box">
          <NavbarStart>
          ...
          <NavbarCenter className="hidden lg:flex">
            <ul className="menu menu-horizontal px-1">
              ...
              <li>
                <details>
                  <summary>Services</summary>
                  <ul className="bg-base-100 rounded-box z-10 p-2 shadow">
                    <li>
                      <a>Web Development</a>
                    </li>
                    <li>
      ...
      <ShowcaseSection
        title="Navbar with Search Input"
        description="Navbar with search functionality."
      >
        <Navbar className="rounded-box">
          <NavbarStart>
      ...
      <ShowcaseSection
        title="Navbar with Shadow and Border"
        description="Navbar with shadow and border styling."
      >
        <div className="space-y-4">
      ...
      >
        <div className="from-primary to-secondary rounded-box bg-gradient-to-r p-8">
