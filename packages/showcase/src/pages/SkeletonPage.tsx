...
export function SkeletonPage() {
	return (
		<ComponentPage title="Skeleton" description="A placeholder preview of content before the data loads.">
			...
			<ShowcaseSection title="Card Skeleton">
				<div className="w-72 p-4 bg-base-200 rounded-lg space-y-4">
