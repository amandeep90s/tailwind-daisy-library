    ...
    <ComponentPage title="Kbd" description="Displays a keyboard key or shortcut.">
      ...
      <ShowcaseSection title="Keyboard Shortcuts">
        <div className="flex items-center gap-1">
          ...
          <span>+</span>
          <Kbd>C</Kbd>
          <span className="text-base-content/60 ml-4">Copy</span>
        </div>
        <div className="flex items-center gap-1">
          <Kbd>Ctrl</Kbd>
          <span>+</span>
          <Kbd>V</Kbd>
          <span className="text-base-content/60 ml-4">Paste</span>
        </div>
        <div className="flex items-center gap-1">
          <Kbd>Ctrl</Kbd>
          <span>+</span>
          ...
          <span>+</span>
          <Kbd>P</Kbd>
          <span className="text-base-content/60 ml-4">Command Palette</span>
        </div>
      </ShowcaseSection>
