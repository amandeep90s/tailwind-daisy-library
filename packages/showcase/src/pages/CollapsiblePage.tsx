  ...
  return (
    ...
    >
      <ShowcaseSection
        ...
        description="Click to toggle content visibility."
      >
        <div className="w-full max-w-md">
          <Collapsible
            trigger={<button className="btn btn-sm">Toggle Content</button>}
          >
            <div className="space-y-2">
              <p>This content can be collapsed and expanded.</p>
              <p>
                It's useful for hiding less important information until needed.
              </p>
            </div>
          </Collapsible>
        </div>
      ...
      >
        <div className="w-full max-w-md space-y-4">
          ...
          <Collapsible
            ...
            trigger={
              <span className="text-sm font-medium">Controlled Content</span>
            }
          >
      ...
      <ShowcaseSection
        title="Default Open"
        description="Collapsible can start in open state."
      >
        <div className="w-full max-w-md">
          <Collapsible
            defaultOpen
            trigger={
              <span className="text-sm font-medium">Default Open Content</span>
            }
          >
            <div className="p-4 bg-base-200 rounded">
          ...
          <div className="collapse collapse-arrow bg-base-200">
            ...
            <div className="collapse-content">
              <p>
                ...
                customizable UI components with clean designs.
              </p>
            </div>
          </div>
          <div className="collapse collapse-arrow bg-base-200">
