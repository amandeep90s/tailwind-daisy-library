...
export function NativeSelectPage() {
	...
	return (
		<ComponentPage title="Native Select" description="A native HTML select element with DaisyUI styling.">
			<ShowcaseSection title="Default">
				<div className="w-72">
					<NativeSelect options={options} value={value} onChange={(e) => setValue(e.target.value)} />
				</div>
			</ShowcaseSection>
